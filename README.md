...
| 套餐 | 价格 | 额度 | 说明 |
|------|------|------|------|
| trial 体验 | ¥0 | 3 次（一次性） | 注册赠送，用完即止，不按月重置 |
| monthly 包月 | ¥39/月 | 40 次/月 | 自然月重置，当月未用完月底清零 |
| yearly 包年 | ¥399/年 | 600 次/年 | 订阅期内有效（不按月清零），续费换新池 |
| unlimited 超级账号 | — | 不限次数 | 自营专用，`python app.py set-super <access_code>` 设置 |

- 仅 OCR 重阶段（批改试卷）消耗额度；矩阵分析/周报免费；运营账号豁免。
- 收款（运营端"订阅管理 → 记录收款"）自动联动套餐：包月 +30 天、包年 +365 天；同套餐包月续费不清当月用量，包年续费换新 600 次池。
